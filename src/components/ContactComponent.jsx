                     ...
                     <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname"  className="form-control" name="firstname" placeholder="First Name" validators={{ required, minLength: minLength(3), maxLength:maxLength(15)}} />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" id="telnum"  name="telnum" placeholder="Telephone Number" validators={{ required, minLength: minLength(3), maxLength:maxLength(15), isNumber}}/>
                                    <Errors className="text-danger" model=".telnum" show="touched"   messages= {{
                                        required : 'Required',
                                        minLength:'Must be greather than 2 char',
                                        maxLength:'Must be less than 15 char',
                                        isNumber:'Tel should be number'
                                   }} />
                                </Col>
                            </Row>
                             <Row className="form-group">
                                ...
                                <Col md={{size:6, offset:2}}>
                                    <div className="form-check">
                                        <Label  check>
                                            ...
                                            <Control.checkbox model=".agree" className="form-control"  name="agree" checked={this.state.agree} /> {' '} 
